...
<div class="form-div">
    <form action="/RNA/index.php/Admin/Test/test" method="GET" name="searchForm">
    <p>
			组织类型：
...
<div class="btn">
<a target="_blank"  href="<?php echo U('test4?'.'datay1='.$datay1.'&'.'datay2='.$datay2.'&'.'datay3='.$datay3.'&'.'datax='.$datax.'&'.'tissue_name1='.$tissue_name1.'&'.'tissue_name2='.$tissue_name2.'&'.'tissue_name3='.$tissue_name3); ?>"><b>GO</b></a> 
</div>
