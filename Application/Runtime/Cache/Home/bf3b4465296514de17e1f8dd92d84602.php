<?php if (!defined('THINK_PATH')) exit();?><div class="form-div">
    <form action="/RNA/index.php/Home/Index/search" method="GET" name="searchForm">
    <p>
			组织类型：
			<?php buildSelect('Tissue','tissue_id1','id','tissue_name'); ?>
			<?php buildSelect('Tissue','tissue_id2','id','tissue_name'); ?>
			<?php buildSelect('Tissue','tissue_id3','id','tissue_name'); ?>
	</p>
	<p>
			染色体号：
...
<div class="btn">
<a target="_blank"  href="<?php echo U('draw?'.'datay1='.$datay1.'&'.'datay2='.$datay2.'&'.'datay3='.$datay3.'&'.'datax='.$datax.'&'.'tissue_name1='.$tissue_name1.'&'.'tissue_name2='.$tissue_name2.'&'.'tissue_name3='.$tissue_name3); ?>"><b>GO</b></a> 
</div>
