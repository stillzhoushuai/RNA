...
.explode {
  background:url(/RNA/Public/Admin/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/RNA/Public/Admin/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/RNA/Public/Admin/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/RNA/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            人体组织
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Brain/lst');?>" target="main-frame">大脑</a></li>
                    <li class="menu-item"><a href="<?php echo U('Adipose/lst');?>" target="main_frame">脂肪</a></li>
                    <li class="menu-item"><a href="<?php echo U('Colon/index');?>" target="main_frame">结肠</a></li>
                    <li class="menu-item"><a href="<?php echo U('Heart/lst');?>" target="main-frame">心脏</a></li>
                </ul>
            </li>
...
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/RNA/Public/Admin/Images/menu_minus.gif' : '/RNA/Public/Admin/Images/menu_plus.gif';
