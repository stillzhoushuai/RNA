...
<div class="form-div">
    <form action="/RNA/index.php/Home/Breast/search?tissue_id=5&paper_id=&chr=&rna_editing_location=&fl=&tl=&fr=&tr=" method="POST" name="searchForm">
    <p>
			组织类型：
			<select name="tissue_id">
                    	<option value="">请选择:</option>
                    	<option value="6">breast_Normal</option>
                    	<option value="7">breast_Tumor</option>
            </select>
	</p>
    <p>
			文章名称：
			<?php buildSelect('Breastpaper','paper_id','id','paper_name'); ?>
