...
class BreastModel extends Model{
	//添加时调用create方法允许接收的字段
	protected $insertFields = 'chr,rna_editing_location,rna_editing_type,pre_base,now_base,sum_bases,reads_editing_rate,sample,add_time,colon_desc,tissue_id';
	//修改时调用create方法允许接受的字段
	protected $updateFields = 'id,chr,rna_editing_location,rna_editing_type,pre_base,now_base,sum_bases,reads_editing_rate,sample,add_time,colon_desc,tissue_id';
	//定义验证规则
	...
	protected function _before_insert(&$data,$option){
	    ...
	    //我们自己来过滤这个字段
	    $data['colon_desc']=removeXSS($_POST['colon_desc']);
	}
